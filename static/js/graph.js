...
$(document).ready(function(){
  ...
  graph.width  = $("#graph-container").width() - graph_margin.left - graph_margin.right,
  ...
  // Initial zooming out
  d3.select("#graph-container > svg").call(zoom.transform, d3.zoomIdentity.translate((graph.width-0.1*graph.width)/2, (graph_height-0.1*graph_height)/2).scale(0.1));
  ...
  simulation = d3.forceSimulation(data.nodes)
                  ...
                  // .force("center", d3.forceCenter(graph.width / 2, graph_height / 2))
                  .alphaMin(0.2)
  ...
  nodes.attr("cx", graph.width / 2).attr("cy", graph_height / 2)
